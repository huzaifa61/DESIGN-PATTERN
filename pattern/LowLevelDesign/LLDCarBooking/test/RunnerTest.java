package LLDCarBooking.test;

import LLDCarBooking.controller.CabsController;


import static org.junit.jupiter.api.Assertions.assertThrows;

import LLDCarBooking.controller.RidersController;
import LLDCarBooking.database.CabsManager;
import LLDCarBooking.database.RideManager;
import LLDCarBooking.database.TripsManager;
import LLDCarBooking.exceptions.*;
import LLDCarBooking.strategies.CabMatchingStrategy;
import LLDCarBooking.strategies.DefaultCabMatchingStrategy;
import LLDCarBooking.strategies.DefaultPricingStrategy;
...
public class RunnerTest {
    ...
    void setUp() {
        ...
        RideManager ridersManager = new RideManager();
    ...
    void testCabBookingFlow() {
        ...
        cabsController.updateCabAvalailability(c2, false);
        cabsController.updateCabAvalailability(c4, false);
        ...
        cabsController.updateEndTrip(c5);
        ...
        assertThrows(CabNotFoundException.class, () -> {
            cabsController.updateCabAvalailability("shss", false);
        });
    }
}
